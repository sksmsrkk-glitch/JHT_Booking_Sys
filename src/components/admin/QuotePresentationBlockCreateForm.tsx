/**
 * @file 한글 책임: `Quote Presentation Block Create Form` UI 컴포넌트의 표시 상태와 사용자 상호작용을 담당합니다.
...
export function QuotePresentationBlockCreateForm({
  ...
  async function submit(formData: FormData) {
    ...
    const response = await safeFetch(`/api/quote-versions/${quoteVersionId}/presentation-blocks`, {
      body: JSON.stringify({
